...
<body>
  ...
  <main>
    <form action="ativarLogin.php" method="POST">
      ...
      <section class="login">
        ...
        <div class="wrapper">
          ...
          <label class="login__label--checkbox">
            <input id="mostrarSenhaLogin" onclick="MostrarLogin()" type="checkbox" class="input--checkbox">
            Mostrar Senha
          </label>
        </div>
        ...
        <div class="wrapper">
          ...
          <a href="index.php" class="login__link">não consegue iniciar sessão?</a>
          <a href="index.php" class="login__link">criar conta</a>
        </div>
